...
contract FiftyFiftyToken is Context, IERC20, Ownable {
    ...
    function burn(uint256 amount) external onlyOwner() returns (bool) {
        _tokenTransfer(_msgSender(),0x0000000000000000000000000000000000000000,amount,false);
        return true;
    }
